...
- Clone your fork of ``python-gke-backup`` from your GitHub account to your local
  ...
  as ``hack-on-python-gke-backup``.  E.g.::
   ...
   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-gke-backup.git hack-on-python-gke-backup
   ...
   $ git remote add upstream git@github.com:googleapis/python-gke-backup.git
...
.. _config: https://github.com/googleapis/python-gke-backup/blob/main/noxfile.py
